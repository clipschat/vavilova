<?php
    ...
    class TextComponent extends CApplicationComponent
    {
        ...
        public static function cutLink( $text, $length, $delim = " ", $tail = "", $url )
        {
            ...
            return ( mb_substr( $text, 0, $pos, 'utf-8' ) . '... ' . CHtml::link( $tail, $url ) );
        }

        public static function cutStrip( $text, $length, $delim = " ", $tail = "" )
        {
