...
class CQTreeGridView extends GridView
{
    ...
    public function init()
    {
        ...
        if($this->baseTreeTableUrl===null)
            $this->baseTreeTableUrl=Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('ext.QGridView.treeTable'));
        
        if($this->baseJuiUrl===null)
            $this->baseJuiUrl=Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('ext.QGridView.jui'));
