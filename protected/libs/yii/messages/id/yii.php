 ...
 */
return array (
  'Action class {class} must implement the "run" method.' => 'Action class {class} harus mengimplementasi method "run".',
  'Adding a foreign key constraint to an existing table is not supported by SQLite.' => 'SQLite tidak mendukung penambahan constraint foreign key ke tabel yang ada.',
  'Altering a DB column is not supported by SQLite.' => 'SQLite tidak mendukung pengubahan kolom DB.',
  'CDbCommand::execute() failed: {error}. The SQL statement executed was: {sql}.' => 'CDbCommand::execute() gagal: {error}. Statement SQL yang dijalankan adalah: {sql}.',
  'CDbCommand::{method}() failed: {error}. The SQL statement executed was: {sql}.' => 'CDbCommand::{method}() gagal: {error}. Statement SQL yang dijalankan adalah: {sql}.',
  'Dropping DB column is not supported by SQLite.' => 'SQLite tidak mendukung drop kolom DB.',
  'Dropping a foreign key constraint is not supported by SQLite.' => 'SQLite tidak mendukung drop constraint foreign key.',
  'Filter "{filter}" is invalid. Controller "{class}" does not have the filter method "filter{filter}".' => '',
  'Property CMaskedTextField.mask cannot be empty.' => 'Property CMaskedTextField.mask tidak boleh kosong.',
  'Renaming a DB column is not supported by SQLite.' => 'SQLite tidak mendukung pengubahan nama kolom DB.',
  'The "db" application component must be configured to be a CDbConnection object.' => 'Komponen aplikasi "db" harus dikonfigurasi sebagai objek CDbConnection.',
  'The DB query must contain the "from" portion.' => 'Query DB query harus mengandung bagian "from".',
  'The format of {attribute} is invalid.' => 'Format {attribute} tidak valid.',
  'Unable to find "{column}" in table "{table}".' => 'Tidak dapat menemukan "{column}" di dalam tabel "{table}".',
  ...
  'The first element in a filter configuration must be the filter class.' => 'Elemen pertama dalam konfigurasi filter harus berupa kelas filter.',
  ...
  'The module path "{path}" is not a valid directory.' => 'Path module "{path}" bukan direktori yang valid.',
  ...
  'Unable to replay the action "{object}.{method}". The method does not exist.' => 'Tidak bisa memainkan action "{object}.{method}". Metode tidak ada.',
  'Unable to resolve the request "{route}".' => 'Tidak bisa me-resolve request "{route}"',
