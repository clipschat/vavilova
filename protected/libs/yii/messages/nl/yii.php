 ...
 */
return array (
  'Action class {class} must implement the "run" method.' => 'De action-class {class} moet de "run" function implementeren.',
  'CDbCommand::execute() failed: {error}. The SQL statement executed was: {sql}.' => 'Fout in CDbCommand::execute(): {error}. Het uitgevoerde SQL statement is: {sql}.',
  'CDbCommand::{method}() failed: {error}. The SQL statement executed was: {sql}.' => 'Fout in CDbCommand::{method}(): {error}. Het uitgevoerde SQL statement is: {sql}.',
  'Filter "{filter}" is invalid. Controller "{class}" does not have the filter method "filter{filter}".' => 'Filter "{filter}" is ongeldig. Controller "{class}" heeft geen filter-functie "filter{filter}".',
  'Property CMaskedTextField.mask cannot be empty.' => 'Property CMaskedTextField.mask mag niet leeg zijn.',
