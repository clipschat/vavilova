...
return array (
  ...
  'Adding a foreign key constraint to an existing table is not supported by SQLite.' => 'Tillägg av referensattributrestriktion i existerande tabell stöds inte av SQLite.',
  'Altering a DB column is not supported by SQLite.' => 'Ändring av DB.kolumn stöds inte av SQLite.',
  'CDbCommand::execute() failed: {error}. The SQL statement executed was: {sql}.' => 'CDbCommand::execute() misslyckades: {error}. Exekverad SQL-sats: {sql}.',
  'CDbCommand::{method}() failed: {error}. The SQL statement executed was: {sql}.' => 'CDbCommand::{method}() misslyckades: {error}. Exekverad SQL-sats: {sql}.',
  'Dropping DB column is not supported by SQLite.' => 'Borttagning av DB-kolumn stöds inte av SQLite.',
  'Dropping a foreign key constraint is not supported by SQLite.' => 'Borttagning av referensattributrestriktion stöds inte av SQLite.',
  'Filter "{filter}" is invalid. Controller "{class}" does not have the filter method "filter{filter}".' => 'Filtret "{filter}" är otillåtet. Kontrollern "{class}" innehåller inte filtermetoden "filter{filter}".',
  'Property CMaskedTextField.mask cannot be empty.' => 'Propertyn CMaskedTextField.mask kan inte vara blank.',
  'Renaming a DB column is not supported by SQLite.' => 'Namnbyte på en DB-kolumn stöds inta av SQLite.',
  'The "db" application component must be configured to be a CDbConnection object.' => 'Applikationskomponenten "db" måste konfigureras till att vara ett CDbConnection-objekt.',
  'The DB query must contain the "from" portion.' => 'DB-frågan måste innehålla ett "from"-led.',
  'The format of {attribute} is invalid.' => '{attribute} har otillåtet format.',
